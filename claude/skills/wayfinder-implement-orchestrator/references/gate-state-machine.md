...
| `collect` | 5 分钟 Herdr status check、worker pane readback | 每个 worker 报告 status、commit if changed、checks、dirty state、touched files | worker blocked/off-scope 或缺少 final report |
